namespace cryptDES.Lib.DES
{
    ...
    {
        // IP таблица (Initial Permutation)
        ...
        // PC1 таблица (Key Schedule - 56 bits from 64)
        ...
        // PC2 таблица (Key Schedule - 48 bits from 56)
